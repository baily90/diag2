...
const GroupFormOne: Array<FieldType> = [
  {
    ...
    calIsVisible: (getFieldsValue) => getFieldsValue(['tabs', 'left', 'thyroid_size']) !== 3,
    extraProps: {
      options: thyroidEcho,
    },
  },
  ...
  },
  {
    ...
    name: ['tabs', 'left', 'tuber_num'],
    type: 'complex',
    calIsVisible: (getFieldsValue) => getFieldsValue(['tabs', 'left', 'exist_tuber']) !== 0,
    extraProps: {
...
const fieldsForm: Array<FieldType> = [
  ...
  },
  {
    ...
    name: ['tabs', 'left', 'thyroid_echoes'],
    type: 'complex',
    calIsVisible: (getFieldsValue) => getFieldsValue(['tabs', 'left', 'thyroid_size']) !== 4,
    extraProps: {
