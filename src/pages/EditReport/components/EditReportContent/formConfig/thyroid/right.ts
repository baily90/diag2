...
const GroupFormOne: Array<FieldType> = [
  {
    ...
    calIsVisible: (getFieldsValue) => getFieldsValue(['tabs', 'right', 'thyroid_size']) !== 3,
    extraProps: {
      options: thyroidEcho,
    },
  },
  ...
  },
  {
    ...
    name: ['tabs', 'right', 'tuber_num'],
    type: 'complex',
    calIsVisible: (getFieldsValue) => getFieldsValue(['tabs', 'right', 'exist_tuber']) !== 0,
    extraProps: {
...
const fieldsForm: Array<FieldType> = [
  ...
  },
  {
    ...
    name: ['tabs', 'right', 'thyroid_echoes'],
    type: 'complex',
    calIsVisible: (getFieldsValue) => getFieldsValue(['tabs', 'right', 'thyroid_size']) !== 4,
    extraProps: {
