...
const GroupFormOne: Array<FieldType> = [
  ...
  },
  {
    ...
    calIsVisible: (getFieldsValue) => getFieldsValue(['tabs', 'left', 'luminal_patch']) !== 1,
    extraProps: {
      innerForm: InnerForm,
    },
  },
...
const fieldsForm: Array<FieldType> = [
  ...
  },
  {
    ...
    name: ['tabs', 'left', 'inside_diameter'],
    type: 'complex',
    calIsVisible: (getFieldsValue) => getFieldsValue(['tabs', 'left', 'not_show']) !== 1,
    extraProps: {
