...
const GroupFormOne: Array<FieldType> = [
  ...
  {
    style: { width: 200 },
    name: ['tabs', 'gallbladder', 'gall_wall_thickness'],
    type: 'number',
    label: '胆壁厚度',
    rules: [{ required: true, message: '请输入胆壁厚度' }],
    calIsVisible: (getFieldsValue) => getFieldsValue(['tabs', 'gallbladder', 'gall_wall']) === 3,
    extraProps: {
      min: 0.1,
      precision: 1,
      step: 0.1,
  ...
  },
  {
    ...
    name: ['tabs', 'gallbladder', 'focus_num'],
    type: 'complex',
    calIsVisible: (getFieldsValue) => getFieldsValue(['tabs', 'gallbladder', 'exist_focus']) !== 2
...
const fieldsForm: Array<FieldType> = [
  ...
  },
  {
    ...
    name: ['tabs', 'gallbladder', 'size'],
    type: 'complex',
    calIsVisible: (getFieldsValue) => getFieldsValue(['tabs', 'gallbladder', 'not_show']) !== 1,
    extraProps: {
